...
export const rasaURL = "http://localhost:5005";
...
export const rowsCourse: GridRowsProp = [
	...
	},
	{
		...
		description: "Organiser des événements clé en main et animer les sites",
	},
	{
		id: 7,
		code_course: "RSD",
	...
	},
	{
		...
		description: "Concilier vie personnelle et vie professionnelle",
	},
	{
		id: 10,
		code_course: "ASS",
		label_course: "S'informer, assister et accompagner les utilisateurs",
		description: "Assister et orienter l'utilisateur dans son parcours",
	},
];
